          ...
          <>
            ...
            <div className="space-y-2">
              {(["garasje", "carport", "bod"] as GType[]).map((t) => (
                <RadioCard key={t} selected={data.type === t} onClick={() => setData({ ...data, type: t })} title={LABEL[t]} desc={t === "garasje" ? "Lukket garasje med port" : t === "carport" ? "Ã…pen carport med tak" : "Bod, uthus eller verksted"} />
              ))}
            </div>
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Under 50 mÂ² er som regel unntatt sÃ¸knad</p>
            </div>
            <div>
            ...
            <Alert>Garasje â‰¤ 50 mÂ² og â‰¥ 1 m fra nabogrense er normalt unntatt sÃ¸knad (SAK10 Â§ 4-1 b).</Alert>
